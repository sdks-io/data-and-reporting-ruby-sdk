...
module ShellDataReportingApIs
  # LoggedInUserRes Model.
  class LoggedInUserRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[LoggedInUserResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (LoggedInUserResponse.from_hash(structure) if structure)
        end
      end
      ...
      LoggedInUserRes.new(request_id,
                          status,
                          data)
    end
