...
module ShellDataReportingApIs
  ...
  class AuditResponseAuditsItems < BaseModel
    ...
    def initialize(account_id = SKIP, account_number = SKIP,
                   ...
                   user_display_name = SKIP, panid = SKIP, masked_pan = SKIP)
    ...
    def to_s
      ...
      " #{@user_display_name}, panid: #{@panid}, masked_pan: #{@masked_pan}>"
    end
    ...
    def inspect
      ...
      " user_display_name: #{@user_display_name.inspect}, panid: #{@panid.inspect}, masked_pan:"\
      " #{@masked_pan.inspect}>"
    end
  end
end
