...
module ShellDataReportingApIs
  ...
  class CustomerDetailResponse < BaseModel
    ...
    def to_s
      ...
      " #{@default_pin_advice_type}, pin_advice_types: #{@pin_advice_types},"\
      " pin_change_allowed_by_cardholder: #{@pin_change_allowed_by_cardholder},"\
      " pin_change_allowed_from_fleet_pin: #{@pin_change_allowed_from_fleet_pin}>"
    end
