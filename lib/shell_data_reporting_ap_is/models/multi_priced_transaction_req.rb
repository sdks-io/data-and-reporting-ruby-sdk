...
module ShellDataReportingApIs
  # MultiPricedTransactionReq Model.
  class MultiPricedTransactionReq < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      filters = MultiPricedTransactionRequest.from_hash(hash['Filters']) if hash['Filters']
      page = hash['Page'] ||= 1
      page_size = hash['PageSize'] ||= 50

      # Create object from extracted values.
      MultiPricedTransactionReq.new(filters,
                                    page,
                                    page_size)
    end
