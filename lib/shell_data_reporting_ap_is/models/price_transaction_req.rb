...
module ShellDataReportingApIs
  # PriceTransactionReq Model.
  class PriceTransactionReq < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [PriceTransactionRequest]
    ...
    def self.from_hash(hash)
      ...
      filters = PriceTransactionRequest.from_hash(hash['Filters']) if hash['Filters']
      page = hash['Page'] ||= 1
      page_size = hash['PageSize'] ||= 50

      # Create object from extracted values.
      PriceTransactionReq.new(filters,
                              page,
                              page_size)
    end
