...
module ShellDataReportingApIs
  # PricedTransactionRes Model.
  class PricedTransactionRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[PricedTransactionResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (PricedTransactionResponse.from_hash(structure) if structure)
        end
      end
      ...
      PricedTransactionRes.new(request_id,
                               status,
                               data,
                               page,
                               total_records,
