...
module ShellDataReportingApIs
  # CardUsageSummaryRes Model.
  class CardUsageSummaryRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[CardUsageSummaryResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (CardUsageSummaryResponse.from_hash(structure) if structure)
        end
      end
      ...
      CardUsageSummaryRes.new(request_id,
                              status,
                              data,
                              warnings)
    end
