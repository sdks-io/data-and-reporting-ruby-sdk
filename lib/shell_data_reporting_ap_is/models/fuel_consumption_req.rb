...
module ShellDataReportingApIs
  # FuelConsumptionReq Model.
  class FuelConsumptionReq < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      filters = FuelConsumptionRequest.from_hash(hash['Filters']) if hash['Filters']

      # Create object from extracted values.
      FuelConsumptionReq.new(filters)
    end
