...
module ShellDataReportingApIs
  ...
  class BearerToken < CoreLibrary::HeaderAuth
    ...
    def initialize(bearer_token_credentials, config)
      ...
      @_o_auth_clock_skew = bearer_token_credentials.o_auth_clock_skew unless
        bearer_token_credentials.nil? || bearer_token_credentials.o_auth_clock_skew.nil?
      @_o_auth_token_provider = bearer_token_credentials.o_auth_token_provider unless
        bearer_token_credentials.nil? || bearer_token_credentials.o_auth_token_provider.nil?
      @_o_auth_on_token_update = bearer_token_credentials.o_auth_on_token_update unless
        bearer_token_credentials.nil? || bearer_token_credentials.o_auth_on_token_update.nil?
